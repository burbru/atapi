...
// checks if the PageMessageBoardWithDetailsView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageMessageBoardWithDetailsView{}

// PageMessageBoardWithDetailsView struct for PageMessageBoardWithDetailsView
type PageMessageBoardWithDetailsView struct {
	Content []MessageBoardWithDetailsView `json:"content,omitempty"`
...
func NewPageMessageBoardWithDetailsView() *PageMessageBoardWithDetailsView {
	this := PageMessageBoardWithDetailsView{}
	return &this
}
...
func (o *PageMessageBoardWithDetailsView) GetContent() []MessageBoardWithDetailsView {
	if o == nil || IsNil(o.Content) {
		var ret []MessageBoardWithDetailsView
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []MessageBoardWithDetailsView and assigns it to the Content field.
func (o *PageMessageBoardWithDetailsView) SetContent(v []MessageBoardWithDetailsView) {
	o.Content = v
}
...
func (o PageMessageBoardWithDetailsView) MarshalJSON() ([]byte, error) {
...
func (o PageMessageBoardWithDetailsView) ToMap() (map[string]interface{}, error) {
...
type NullablePageMessageBoardWithDetailsView struct {
	value *PageMessageBoardWithDetailsView
	isSet bool
}

func (v NullablePageMessageBoardWithDetailsView) Get() *PageMessageBoardWithDetailsView {
	return v.value
}

func (v *NullablePageMessageBoardWithDetailsView) Set(val *PageMessageBoardWithDetailsView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageMessageBoardWithDetailsView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageMessageBoardWithDetailsView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageMessageBoardWithDetailsView(val *PageMessageBoardWithDetailsView) *NullablePageMessageBoardWithDetailsView {
	return &NullablePageMessageBoardWithDetailsView{value: val, isSet: true}
}

func (v NullablePageMessageBoardWithDetailsView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageMessageBoardWithDetailsView) UnmarshalJSON(src []byte) error {
	v.isSet = true
