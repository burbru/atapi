...
// checks if the PageSecurityOrderLogEntryWithPriceDiffView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageSecurityOrderLogEntryWithPriceDiffView{}

// PageSecurityOrderLogEntryWithPriceDiffView struct for PageSecurityOrderLogEntryWithPriceDiffView
type PageSecurityOrderLogEntryWithPriceDiffView struct {
	Content []SecurityOrderLogEntryWithPriceDiffView `json:"content,omitempty"`
...
func NewPageSecurityOrderLogEntryWithPriceDiffView() *PageSecurityOrderLogEntryWithPriceDiffView {
	this := PageSecurityOrderLogEntryWithPriceDiffView{}
	return &this
}
...
func (o *PageSecurityOrderLogEntryWithPriceDiffView) GetContent() []SecurityOrderLogEntryWithPriceDiffView {
	if o == nil || IsNil(o.Content) {
		var ret []SecurityOrderLogEntryWithPriceDiffView
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []SecurityOrderLogEntryWithPriceDiffView and assigns it to the Content field.
...
func (o *PageSecurityOrderLogEntryWithPriceDiffView) SetFirst(v bool) {
	o.First = &v
}
...
func (o PageSecurityOrderLogEntryWithPriceDiffView) MarshalJSON() ([]byte, error) {
...
func (o PageSecurityOrderLogEntryWithPriceDiffView) ToMap() (map[string]interface{}, error) {
...
type NullablePageSecurityOrderLogEntryWithPriceDiffView struct {
	value *PageSecurityOrderLogEntryWithPriceDiffView
	isSet bool
}

func (v NullablePageSecurityOrderLogEntryWithPriceDiffView) Get() *PageSecurityOrderLogEntryWithPriceDiffView {
	return v.value
}

func (v *NullablePageSecurityOrderLogEntryWithPriceDiffView) Set(val *PageSecurityOrderLogEntryWithPriceDiffView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageSecurityOrderLogEntryWithPriceDiffView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageSecurityOrderLogEntryWithPriceDiffView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageSecurityOrderLogEntryWithPriceDiffView(val *PageSecurityOrderLogEntryWithPriceDiffView) *NullablePageSecurityOrderLogEntryWithPriceDiffView {
	return &NullablePageSecurityOrderLogEntryWithPriceDiffView{value: val, isSet: true}
}

func (v NullablePageSecurityOrderLogEntryWithPriceDiffView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageSecurityOrderLogEntryWithPriceDiffView) UnmarshalJSON(src []byte) error {
	v.isSet = true
