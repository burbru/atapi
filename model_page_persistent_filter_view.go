...
// checks if the PagePersistentFilterView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagePersistentFilterView{}

// PagePersistentFilterView struct for PagePersistentFilterView
type PagePersistentFilterView struct {
	Content []PersistentFilterView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []PersistentFilterView and assigns it to the Content field.
...
func (o PagePersistentFilterView) MarshalJSON() ([]byte, error) {
...
func (o PagePersistentFilterView) ToMap() (map[string]interface{}, error) {
...
type NullablePagePersistentFilterView struct {
	value *PagePersistentFilterView
	isSet bool
}

func (v NullablePagePersistentFilterView) Get() *PagePersistentFilterView {
	return v.value
}

func (v *NullablePagePersistentFilterView) Set(val *PagePersistentFilterView) {
	v.value = val
	v.isSet = true
}

func (v NullablePagePersistentFilterView) IsSet() bool {
	return v.isSet
}

func (v *NullablePagePersistentFilterView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagePersistentFilterView(val *PagePersistentFilterView) *NullablePagePersistentFilterView {
	return &NullablePagePersistentFilterView{value: val, isSet: true}
}

func (v NullablePagePersistentFilterView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagePersistentFilterView) UnmarshalJSON(src []byte) error {
	v.isSet = true
