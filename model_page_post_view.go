...
// checks if the PagePostView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagePostView{}

// PagePostView struct for PagePostView
type PagePostView struct {
	Content []PostView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []PostView and assigns it to the Content field.
...
func (o PagePostView) MarshalJSON() ([]byte, error) {
...
func (o PagePostView) ToMap() (map[string]interface{}, error) {
...
type NullablePagePostView struct {
	value *PagePostView
	isSet bool
}

func (v NullablePagePostView) Get() *PagePostView {
	return v.value
}

func (v *NullablePagePostView) Set(val *PagePostView) {
	v.value = val
	v.isSet = true
}

func (v NullablePagePostView) IsSet() bool {
	return v.isSet
}

func (v *NullablePagePostView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagePostView(val *PagePostView) *NullablePagePostView {
	return &NullablePagePostView{value: val, isSet: true}
}

func (v NullablePagePostView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagePostView) UnmarshalJSON(src []byte) error {
	v.isSet = true
