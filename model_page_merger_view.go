...
// checks if the PageMergerView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageMergerView{}

// PageMergerView struct for PageMergerView
type PageMergerView struct {
	Content []MergerView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []MergerView and assigns it to the Content field.
...
func (o PageMergerView) MarshalJSON() ([]byte, error) {
...
func (o PageMergerView) ToMap() (map[string]interface{}, error) {
...
type NullablePageMergerView struct {
	value *PageMergerView
	isSet bool
}

func (v NullablePageMergerView) Get() *PageMergerView {
	return v.value
}

func (v *NullablePageMergerView) Set(val *PageMergerView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageMergerView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageMergerView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageMergerView(val *PageMergerView) *NullablePageMergerView {
	return &NullablePageMergerView{value: val, isSet: true}
}

func (v NullablePageMergerView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageMergerView) UnmarshalJSON(src []byte) error {
	v.isSet = true
