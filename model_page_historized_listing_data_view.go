...
// checks if the PageHistorizedListingDataView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageHistorizedListingDataView{}

// PageHistorizedListingDataView struct for PageHistorizedListingDataView
type PageHistorizedListingDataView struct {
	Content []HistorizedListingDataView `json:"content,omitempty"`
...
func NewPageHistorizedListingDataView() *PageHistorizedListingDataView {
	this := PageHistorizedListingDataView{}
	return &this
}
...
func (o *PageHistorizedListingDataView) GetContent() []HistorizedListingDataView {
	if o == nil || IsNil(o.Content) {
		var ret []HistorizedListingDataView
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []HistorizedListingDataView and assigns it to the Content field.
...
func (o PageHistorizedListingDataView) MarshalJSON() ([]byte, error) {
...
func (o PageHistorizedListingDataView) ToMap() (map[string]interface{}, error) {
...
type NullablePageHistorizedListingDataView struct {
	value *PageHistorizedListingDataView
	isSet bool
}

func (v NullablePageHistorizedListingDataView) Get() *PageHistorizedListingDataView {
	return v.value
}

func (v *NullablePageHistorizedListingDataView) Set(val *PageHistorizedListingDataView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageHistorizedListingDataView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageHistorizedListingDataView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageHistorizedListingDataView(val *PageHistorizedListingDataView) *NullablePageHistorizedListingDataView {
	return &NullablePageHistorizedListingDataView{value: val, isSet: true}
}

func (v NullablePageHistorizedListingDataView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageHistorizedListingDataView) UnmarshalJSON(src []byte) error {
	v.isSet = true
