...
// checks if the PageNotificationView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageNotificationView{}

// PageNotificationView struct for PageNotificationView
type PageNotificationView struct {
	Content []NotificationView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []NotificationView and assigns it to the Content field.
...
func (o PageNotificationView) MarshalJSON() ([]byte, error) {
...
func (o PageNotificationView) ToMap() (map[string]interface{}, error) {
...
type NullablePageNotificationView struct {
	value *PageNotificationView
	isSet bool
}

func (v NullablePageNotificationView) Get() *PageNotificationView {
	return v.value
}

func (v *NullablePageNotificationView) Set(val *PageNotificationView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageNotificationView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageNotificationView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageNotificationView(val *PageNotificationView) *NullablePageNotificationView {
	return &NullablePageNotificationView{value: val, isSet: true}
}

func (v NullablePageNotificationView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageNotificationView) UnmarshalJSON(src []byte) error {
	v.isSet = true
