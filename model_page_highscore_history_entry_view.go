...
// checks if the PageHighscoreHistoryEntryView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageHighscoreHistoryEntryView{}

// PageHighscoreHistoryEntryView struct for PageHighscoreHistoryEntryView
type PageHighscoreHistoryEntryView struct {
	Content []HighscoreHistoryEntryView `json:"content,omitempty"`
...
func NewPageHighscoreHistoryEntryView() *PageHighscoreHistoryEntryView {
	this := PageHighscoreHistoryEntryView{}
	return &this
}
...
func (o *PageHighscoreHistoryEntryView) GetContent() []HighscoreHistoryEntryView {
	if o == nil || IsNil(o.Content) {
		var ret []HighscoreHistoryEntryView
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []HighscoreHistoryEntryView and assigns it to the Content field.
func (o *PageHighscoreHistoryEntryView) SetContent(v []HighscoreHistoryEntryView) {
	o.Content = v
}
...
func (o PageHighscoreHistoryEntryView) MarshalJSON() ([]byte, error) {
...
func (o PageHighscoreHistoryEntryView) ToMap() (map[string]interface{}, error) {
...
type NullablePageHighscoreHistoryEntryView struct {
	value *PageHighscoreHistoryEntryView
	isSet bool
}

func (v NullablePageHighscoreHistoryEntryView) Get() *PageHighscoreHistoryEntryView {
	return v.value
}

func (v *NullablePageHighscoreHistoryEntryView) Set(val *PageHighscoreHistoryEntryView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageHighscoreHistoryEntryView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageHighscoreHistoryEntryView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageHighscoreHistoryEntryView(val *PageHighscoreHistoryEntryView) *NullablePageHighscoreHistoryEntryView {
	return &NullablePageHighscoreHistoryEntryView{value: val, isSet: true}
}

func (v NullablePageHighscoreHistoryEntryView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageHighscoreHistoryEntryView) UnmarshalJSON(src []byte) error {
	v.isSet = true
