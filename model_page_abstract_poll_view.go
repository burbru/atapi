...
// checks if the PageAbstractPollView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageAbstractPollView{}

// PageAbstractPollView struct for PageAbstractPollView
type PageAbstractPollView struct {
	Content []AbstractPollView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []AbstractPollView and assigns it to the Content field.
...
func (o PageAbstractPollView) MarshalJSON() ([]byte, error) {
...
func (o PageAbstractPollView) ToMap() (map[string]interface{}, error) {
...
type NullablePageAbstractPollView struct {
	value *PageAbstractPollView
	isSet bool
}

func (v NullablePageAbstractPollView) Get() *PageAbstractPollView {
	return v.value
}

func (v *NullablePageAbstractPollView) Set(val *PageAbstractPollView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageAbstractPollView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageAbstractPollView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageAbstractPollView(val *PageAbstractPollView) *NullablePageAbstractPollView {
	return &NullablePageAbstractPollView{value: val, isSet: true}
}

func (v NullablePageAbstractPollView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageAbstractPollView) UnmarshalJSON(src []byte) error {
	v.isSet = true
