...
// checks if the PagePriceSpreadListingView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagePriceSpreadListingView{}

// PagePriceSpreadListingView struct for PagePriceSpreadListingView
type PagePriceSpreadListingView struct {
	Content []PriceSpreadListingView `json:"content,omitempty"`
...
func NewPagePriceSpreadListingView() *PagePriceSpreadListingView {
	this := PagePriceSpreadListingView{}
	return &this
}
...
func (o *PagePriceSpreadListingView) GetContent() []PriceSpreadListingView {
	if o == nil || IsNil(o.Content) {
		var ret []PriceSpreadListingView
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []PriceSpreadListingView and assigns it to the Content field.
func (o *PagePriceSpreadListingView) SetContent(v []PriceSpreadListingView) {
	o.Content = v
}
...
func (o PagePriceSpreadListingView) MarshalJSON() ([]byte, error) {
...
func (o PagePriceSpreadListingView) ToMap() (map[string]interface{}, error) {
...
type NullablePagePriceSpreadListingView struct {
	value *PagePriceSpreadListingView
	isSet bool
}

func (v NullablePagePriceSpreadListingView) Get() *PagePriceSpreadListingView {
	return v.value
}

func (v *NullablePagePriceSpreadListingView) Set(val *PagePriceSpreadListingView) {
	v.value = val
	v.isSet = true
}

func (v NullablePagePriceSpreadListingView) IsSet() bool {
	return v.isSet
}

func (v *NullablePagePriceSpreadListingView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagePriceSpreadListingView(val *PagePriceSpreadListingView) *NullablePagePriceSpreadListingView {
	return &NullablePagePriceSpreadListingView{value: val, isSet: true}
}

func (v NullablePagePriceSpreadListingView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagePriceSpreadListingView) UnmarshalJSON(src []byte) error {
	v.isSet = true
