...
// checks if the PageSponsoringGoalView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageSponsoringGoalView{}

// PageSponsoringGoalView struct for PageSponsoringGoalView
type PageSponsoringGoalView struct {
	Content []SponsoringGoalView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []SponsoringGoalView and assigns it to the Content field.
func (o *PageSponsoringGoalView) SetContent(v []SponsoringGoalView) {
	o.Content = v
}
...
func (o PageSponsoringGoalView) MarshalJSON() ([]byte, error) {
...
func (o PageSponsoringGoalView) ToMap() (map[string]interface{}, error) {
...
type NullablePageSponsoringGoalView struct {
	value *PageSponsoringGoalView
	isSet bool
}

func (v NullablePageSponsoringGoalView) Get() *PageSponsoringGoalView {
	return v.value
}

func (v *NullablePageSponsoringGoalView) Set(val *PageSponsoringGoalView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageSponsoringGoalView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageSponsoringGoalView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageSponsoringGoalView(val *PageSponsoringGoalView) *NullablePageSponsoringGoalView {
	return &NullablePageSponsoringGoalView{value: val, isSet: true}
}

func (v NullablePageSponsoringGoalView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageSponsoringGoalView) UnmarshalJSON(src []byte) error {
	v.isSet = true
