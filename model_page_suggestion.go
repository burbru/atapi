...
// checks if the PageSuggestion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageSuggestion{}

// PageSuggestion struct for PageSuggestion
type PageSuggestion struct {
	Content []Suggestion `json:"content,omitempty"`
...
// SetContent gets a reference to the given []Suggestion and assigns it to the Content field.
...
func (o PageSuggestion) MarshalJSON() ([]byte, error) {
...
func (o PageSuggestion) ToMap() (map[string]interface{}, error) {
...
type NullablePageSuggestion struct {
	value *PageSuggestion
	isSet bool
}

func (v NullablePageSuggestion) Get() *PageSuggestion {
	return v.value
}

func (v *NullablePageSuggestion) Set(val *PageSuggestion) {
	v.value = val
	v.isSet = true
}

func (v NullablePageSuggestion) IsSet() bool {
	return v.isSet
}

func (v *NullablePageSuggestion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageSuggestion(val *PageSuggestion) *NullablePageSuggestion {
	return &NullablePageSuggestion{value: val, isSet: true}
}

func (v NullablePageSuggestion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageSuggestion) UnmarshalJSON(src []byte) error {
	v.isSet = true
