...
// checks if the PageAllianceHighscoreEntryView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageAllianceHighscoreEntryView{}

// PageAllianceHighscoreEntryView struct for PageAllianceHighscoreEntryView
type PageAllianceHighscoreEntryView struct {
	Content []AllianceHighscoreEntryView `json:"content,omitempty"`
...
func NewPageAllianceHighscoreEntryView() *PageAllianceHighscoreEntryView {
	this := PageAllianceHighscoreEntryView{}
	return &this
}
...
func (o *PageAllianceHighscoreEntryView) GetContent() []AllianceHighscoreEntryView {
	if o == nil || IsNil(o.Content) {
		var ret []AllianceHighscoreEntryView
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []AllianceHighscoreEntryView and assigns it to the Content field.
func (o *PageAllianceHighscoreEntryView) SetContent(v []AllianceHighscoreEntryView) {
	o.Content = v
}
...
func (o PageAllianceHighscoreEntryView) MarshalJSON() ([]byte, error) {
...
func (o PageAllianceHighscoreEntryView) ToMap() (map[string]interface{}, error) {
...
type NullablePageAllianceHighscoreEntryView struct {
	value *PageAllianceHighscoreEntryView
	isSet bool
}

func (v NullablePageAllianceHighscoreEntryView) Get() *PageAllianceHighscoreEntryView {
	return v.value
}

func (v *NullablePageAllianceHighscoreEntryView) Set(val *PageAllianceHighscoreEntryView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageAllianceHighscoreEntryView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageAllianceHighscoreEntryView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageAllianceHighscoreEntryView(val *PageAllianceHighscoreEntryView) *NullablePageAllianceHighscoreEntryView {
	return &NullablePageAllianceHighscoreEntryView{value: val, isSet: true}
}

func (v NullablePageAllianceHighscoreEntryView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageAllianceHighscoreEntryView) UnmarshalJSON(src []byte) error {
	v.isSet = true
