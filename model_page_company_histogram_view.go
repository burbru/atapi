...
// checks if the PageCompanyHistogramView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageCompanyHistogramView{}

// PageCompanyHistogramView struct for PageCompanyHistogramView
type PageCompanyHistogramView struct {
	Content []CompanyHistogramView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []CompanyHistogramView and assigns it to the Content field.
func (o *PageCompanyHistogramView) SetContent(v []CompanyHistogramView) {
	o.Content = v
}
...
func (o PageCompanyHistogramView) MarshalJSON() ([]byte, error) {
...
func (o PageCompanyHistogramView) ToMap() (map[string]interface{}, error) {
...
type NullablePageCompanyHistogramView struct {
	value *PageCompanyHistogramView
	isSet bool
}

func (v NullablePageCompanyHistogramView) Get() *PageCompanyHistogramView {
	return v.value
}

func (v *NullablePageCompanyHistogramView) Set(val *PageCompanyHistogramView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageCompanyHistogramView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageCompanyHistogramView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageCompanyHistogramView(val *PageCompanyHistogramView) *NullablePageCompanyHistogramView {
	return &NullablePageCompanyHistogramView{value: val, isSet: true}
}

func (v NullablePageCompanyHistogramView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageCompanyHistogramView) UnmarshalJSON(src []byte) error {
	v.isSet = true
