...
// checks if the PageHistoryEntryView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageHistoryEntryView{}

// PageHistoryEntryView struct for PageHistoryEntryView
type PageHistoryEntryView struct {
	Content []HistoryEntryView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []HistoryEntryView and assigns it to the Content field.
...
func (o PageHistoryEntryView) MarshalJSON() ([]byte, error) {
...
func (o PageHistoryEntryView) ToMap() (map[string]interface{}, error) {
...
type NullablePageHistoryEntryView struct {
	value *PageHistoryEntryView
	isSet bool
}

func (v NullablePageHistoryEntryView) Get() *PageHistoryEntryView {
	return v.value
}

func (v *NullablePageHistoryEntryView) Set(val *PageHistoryEntryView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageHistoryEntryView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageHistoryEntryView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageHistoryEntryView(val *PageHistoryEntryView) *NullablePageHistoryEntryView {
	return &NullablePageHistoryEntryView{value: val, isSet: true}
}

func (v NullablePageHistoryEntryView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageHistoryEntryView) UnmarshalJSON(src []byte) error {
	v.isSet = true
