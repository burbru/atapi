...
// checks if the PageEmploymentAgreementSalaryPaymentCompactCompanyView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageEmploymentAgreementSalaryPaymentCompactCompanyView{}

// PageEmploymentAgreementSalaryPaymentCompactCompanyView struct for PageEmploymentAgreementSalaryPaymentCompactCompanyView
type PageEmploymentAgreementSalaryPaymentCompactCompanyView struct {
	Content []EmploymentAgreementSalaryPaymentCompactCompanyView `json:"content,omitempty"`
...
func NewPageEmploymentAgreementSalaryPaymentCompactCompanyView() *PageEmploymentAgreementSalaryPaymentCompactCompanyView {
	this := PageEmploymentAgreementSalaryPaymentCompactCompanyView{}
	return &this
}
...
func (o *PageEmploymentAgreementSalaryPaymentCompactCompanyView) GetContent() []EmploymentAgreementSalaryPaymentCompactCompanyView {
	if o == nil || IsNil(o.Content) {
		var ret []EmploymentAgreementSalaryPaymentCompactCompanyView
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []EmploymentAgreementSalaryPaymentCompactCompanyView and assigns it to the Content field.
...
func (o PageEmploymentAgreementSalaryPaymentCompactCompanyView) MarshalJSON() ([]byte, error) {
...
func (o PageEmploymentAgreementSalaryPaymentCompactCompanyView) ToMap() (map[string]interface{}, error) {
...
type NullablePageEmploymentAgreementSalaryPaymentCompactCompanyView struct {
	value *PageEmploymentAgreementSalaryPaymentCompactCompanyView
	isSet bool
}

func (v NullablePageEmploymentAgreementSalaryPaymentCompactCompanyView) Get() *PageEmploymentAgreementSalaryPaymentCompactCompanyView {
	return v.value
}

func (v *NullablePageEmploymentAgreementSalaryPaymentCompactCompanyView) Set(val *PageEmploymentAgreementSalaryPaymentCompactCompanyView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageEmploymentAgreementSalaryPaymentCompactCompanyView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageEmploymentAgreementSalaryPaymentCompactCompanyView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageEmploymentAgreementSalaryPaymentCompactCompanyView(val *PageEmploymentAgreementSalaryPaymentCompactCompanyView) *NullablePageEmploymentAgreementSalaryPaymentCompactCompanyView {
	return &NullablePageEmploymentAgreementSalaryPaymentCompactCompanyView{value: val, isSet: true}
}

func (v NullablePageEmploymentAgreementSalaryPaymentCompactCompanyView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageEmploymentAgreementSalaryPaymentCompactCompanyView) UnmarshalJSON(src []byte) error {
	v.isSet = true
