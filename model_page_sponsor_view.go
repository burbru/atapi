...
// checks if the PageSponsorView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageSponsorView{}

// PageSponsorView struct for PageSponsorView
type PageSponsorView struct {
	Content []SponsorView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []SponsorView and assigns it to the Content field.
...
func (o PageSponsorView) MarshalJSON() ([]byte, error) {
...
func (o PageSponsorView) ToMap() (map[string]interface{}, error) {
...
type NullablePageSponsorView struct {
	value *PageSponsorView
	isSet bool
}

func (v NullablePageSponsorView) Get() *PageSponsorView {
	return v.value
}

func (v *NullablePageSponsorView) Set(val *PageSponsorView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageSponsorView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageSponsorView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageSponsorView(val *PageSponsorView) *NullablePageSponsorView {
	return &NullablePageSponsorView{value: val, isSet: true}
}

func (v NullablePageSponsorView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageSponsorView) UnmarshalJSON(src []byte) error {
	v.isSet = true
