...
// checks if the PageCompanyHighscoreEntryView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageCompanyHighscoreEntryView{}

// PageCompanyHighscoreEntryView struct for PageCompanyHighscoreEntryView
type PageCompanyHighscoreEntryView struct {
	Content []CompanyHighscoreEntryView `json:"content,omitempty"`
...
func NewPageCompanyHighscoreEntryView() *PageCompanyHighscoreEntryView {
	this := PageCompanyHighscoreEntryView{}
	return &this
}
...
func (o *PageCompanyHighscoreEntryView) GetContent() []CompanyHighscoreEntryView {
	if o == nil || IsNil(o.Content) {
		var ret []CompanyHighscoreEntryView
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []CompanyHighscoreEntryView and assigns it to the Content field.
...
func (o PageCompanyHighscoreEntryView) MarshalJSON() ([]byte, error) {
...
func (o PageCompanyHighscoreEntryView) ToMap() (map[string]interface{}, error) {
...
type NullablePageCompanyHighscoreEntryView struct {
	value *PageCompanyHighscoreEntryView
	isSet bool
}

func (v NullablePageCompanyHighscoreEntryView) Get() *PageCompanyHighscoreEntryView {
	return v.value
}

func (v *NullablePageCompanyHighscoreEntryView) Set(val *PageCompanyHighscoreEntryView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageCompanyHighscoreEntryView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageCompanyHighscoreEntryView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageCompanyHighscoreEntryView(val *PageCompanyHighscoreEntryView) *NullablePageCompanyHighscoreEntryView {
	return &NullablePageCompanyHighscoreEntryView{value: val, isSet: true}
}

func (v NullablePageCompanyHighscoreEntryView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageCompanyHighscoreEntryView) UnmarshalJSON(src []byte) error {
	v.isSet = true
