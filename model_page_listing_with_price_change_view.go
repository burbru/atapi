...
// checks if the PageListingWithPriceChangeView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageListingWithPriceChangeView{}

// PageListingWithPriceChangeView struct for PageListingWithPriceChangeView
type PageListingWithPriceChangeView struct {
	Content []ListingWithPriceChangeView `json:"content,omitempty"`
...
func NewPageListingWithPriceChangeView() *PageListingWithPriceChangeView {
	this := PageListingWithPriceChangeView{}
	return &this
}
...
func (o *PageListingWithPriceChangeView) GetContent() []ListingWithPriceChangeView {
	if o == nil || IsNil(o.Content) {
		var ret []ListingWithPriceChangeView
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []ListingWithPriceChangeView and assigns it to the Content field.
...
func (o PageListingWithPriceChangeView) MarshalJSON() ([]byte, error) {
...
func (o PageListingWithPriceChangeView) ToMap() (map[string]interface{}, error) {
...
type NullablePageListingWithPriceChangeView struct {
	value *PageListingWithPriceChangeView
	isSet bool
}

func (v NullablePageListingWithPriceChangeView) Get() *PageListingWithPriceChangeView {
	return v.value
}

func (v *NullablePageListingWithPriceChangeView) Set(val *PageListingWithPriceChangeView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageListingWithPriceChangeView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageListingWithPriceChangeView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageListingWithPriceChangeView(val *PageListingWithPriceChangeView) *NullablePageListingWithPriceChangeView {
	return &NullablePageListingWithPriceChangeView{value: val, isSet: true}
}

func (v NullablePageListingWithPriceChangeView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageListingWithPriceChangeView) UnmarshalJSON(src []byte) error {
	v.isSet = true
