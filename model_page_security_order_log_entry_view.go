...
// checks if the PageSecurityOrderLogEntryView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageSecurityOrderLogEntryView{}

// PageSecurityOrderLogEntryView struct for PageSecurityOrderLogEntryView
type PageSecurityOrderLogEntryView struct {
	Content []SecurityOrderLogEntryView `json:"content,omitempty"`
...
func NewPageSecurityOrderLogEntryView() *PageSecurityOrderLogEntryView {
	this := PageSecurityOrderLogEntryView{}
	return &this
}
...
// SetContent gets a reference to the given []SecurityOrderLogEntryView and assigns it to the Content field.
func (o *PageSecurityOrderLogEntryView) SetContent(v []SecurityOrderLogEntryView) {
	o.Content = v
}
...
func (o PageSecurityOrderLogEntryView) MarshalJSON() ([]byte, error) {
...
func (o PageSecurityOrderLogEntryView) ToMap() (map[string]interface{}, error) {
...
type NullablePageSecurityOrderLogEntryView struct {
	value *PageSecurityOrderLogEntryView
	isSet bool
}

func (v NullablePageSecurityOrderLogEntryView) Get() *PageSecurityOrderLogEntryView {
	return v.value
}

func (v *NullablePageSecurityOrderLogEntryView) Set(val *PageSecurityOrderLogEntryView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageSecurityOrderLogEntryView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageSecurityOrderLogEntryView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageSecurityOrderLogEntryView(val *PageSecurityOrderLogEntryView) *NullablePageSecurityOrderLogEntryView {
	return &NullablePageSecurityOrderLogEntryView{value: val, isSet: true}
}

func (v NullablePageSecurityOrderLogEntryView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageSecurityOrderLogEntryView) UnmarshalJSON(src []byte) error {
	v.isSet = true
