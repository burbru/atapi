...
// checks if the PageListingShareView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageListingShareView{}

// PageListingShareView struct for PageListingShareView
type PageListingShareView struct {
	Content []ListingShareView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []ListingShareView and assigns it to the Content field.
...
func (o PageListingShareView) MarshalJSON() ([]byte, error) {
...
func (o PageListingShareView) ToMap() (map[string]interface{}, error) {
...
type NullablePageListingShareView struct {
	value *PageListingShareView
	isSet bool
}

func (v NullablePageListingShareView) Get() *PageListingShareView {
	return v.value
}

func (v *NullablePageListingShareView) Set(val *PageListingShareView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageListingShareView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageListingShareView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageListingShareView(val *PageListingShareView) *NullablePageListingShareView {
	return &NullablePageListingShareView{value: val, isSet: true}
}

func (v NullablePageListingShareView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageListingShareView) UnmarshalJSON(src []byte) error {
	v.isSet = true
