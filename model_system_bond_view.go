...
// checks if the SystemBondView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemBondView{}

// SystemBondView struct for SystemBondView
type SystemBondView struct {
...
func (o SystemBondView) MarshalJSON() ([]byte, error) {
...
func (o SystemBondView) ToMap() (map[string]interface{}, error) {
...
type NullableSystemBondView struct {
	value *SystemBondView
	isSet bool
}

func (v NullableSystemBondView) Get() *SystemBondView {
	return v.value
}

func (v *NullableSystemBondView) Set(val *SystemBondView) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemBondView) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemBondView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemBondView(val *SystemBondView) *NullableSystemBondView {
	return &NullableSystemBondView{value: val, isSet: true}
}

func (v NullableSystemBondView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemBondView) UnmarshalJSON(src []byte) error {
	v.isSet = true
