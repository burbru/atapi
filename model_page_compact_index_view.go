...
// checks if the PageCompactIndexView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageCompactIndexView{}

// PageCompactIndexView struct for PageCompactIndexView
type PageCompactIndexView struct {
	Content []CompactIndexView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []CompactIndexView and assigns it to the Content field.
...
func (o PageCompactIndexView) MarshalJSON() ([]byte, error) {
...
func (o PageCompactIndexView) ToMap() (map[string]interface{}, error) {
...
type NullablePageCompactIndexView struct {
	value *PageCompactIndexView
	isSet bool
}

func (v NullablePageCompactIndexView) Get() *PageCompactIndexView {
	return v.value
}

func (v *NullablePageCompactIndexView) Set(val *PageCompactIndexView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageCompactIndexView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageCompactIndexView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageCompactIndexView(val *PageCompactIndexView) *NullablePageCompactIndexView {
	return &NullablePageCompactIndexView{value: val, isSet: true}
}

func (v NullablePageCompactIndexView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageCompactIndexView) UnmarshalJSON(src []byte) error {
	v.isSet = true
