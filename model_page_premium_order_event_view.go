...
// checks if the PagePremiumOrderEventView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagePremiumOrderEventView{}

// PagePremiumOrderEventView struct for PagePremiumOrderEventView
type PagePremiumOrderEventView struct {
	Content []PremiumOrderEventView `json:"content,omitempty"`
...
func NewPagePremiumOrderEventView() *PagePremiumOrderEventView {
	this := PagePremiumOrderEventView{}
	return &this
}
...
// SetContent gets a reference to the given []PremiumOrderEventView and assigns it to the Content field.
func (o *PagePremiumOrderEventView) SetContent(v []PremiumOrderEventView) {
	o.Content = v
}
...
func (o PagePremiumOrderEventView) MarshalJSON() ([]byte, error) {
...
func (o PagePremiumOrderEventView) ToMap() (map[string]interface{}, error) {
...
type NullablePagePremiumOrderEventView struct {
	value *PagePremiumOrderEventView
	isSet bool
}

func (v NullablePagePremiumOrderEventView) Get() *PagePremiumOrderEventView {
	return v.value
}

func (v *NullablePagePremiumOrderEventView) Set(val *PagePremiumOrderEventView) {
	v.value = val
	v.isSet = true
}

func (v NullablePagePremiumOrderEventView) IsSet() bool {
	return v.isSet
}

func (v *NullablePagePremiumOrderEventView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagePremiumOrderEventView(val *PagePremiumOrderEventView) *NullablePagePremiumOrderEventView {
	return &NullablePagePremiumOrderEventView{value: val, isSet: true}
}

func (v NullablePagePremiumOrderEventView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagePremiumOrderEventView) UnmarshalJSON(src []byte) error {
	v.isSet = true
