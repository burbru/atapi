...
// checks if the PageDividendPaymentView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageDividendPaymentView{}

// PageDividendPaymentView struct for PageDividendPaymentView
type PageDividendPaymentView struct {
	Content []DividendPaymentView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []DividendPaymentView and assigns it to the Content field.
...
func (o PageDividendPaymentView) MarshalJSON() ([]byte, error) {
...
func (o PageDividendPaymentView) ToMap() (map[string]interface{}, error) {
...
type NullablePageDividendPaymentView struct {
	value *PageDividendPaymentView
	isSet bool
}

func (v NullablePageDividendPaymentView) Get() *PageDividendPaymentView {
	return v.value
}

func (v *NullablePageDividendPaymentView) Set(val *PageDividendPaymentView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageDividendPaymentView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageDividendPaymentView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageDividendPaymentView(val *PageDividendPaymentView) *NullablePageDividendPaymentView {
	return &NullablePageDividendPaymentView{value: val, isSet: true}
}

func (v NullablePageDividendPaymentView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageDividendPaymentView) UnmarshalJSON(src []byte) error {
	v.isSet = true
