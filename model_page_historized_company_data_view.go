...
// checks if the PageHistorizedCompanyDataView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageHistorizedCompanyDataView{}

// PageHistorizedCompanyDataView struct for PageHistorizedCompanyDataView
type PageHistorizedCompanyDataView struct {
	Content []HistorizedCompanyDataView `json:"content,omitempty"`
...
func NewPageHistorizedCompanyDataView() *PageHistorizedCompanyDataView {
	this := PageHistorizedCompanyDataView{}
	return &this
}
...
func (o *PageHistorizedCompanyDataView) GetContent() []HistorizedCompanyDataView {
	if o == nil || IsNil(o.Content) {
		var ret []HistorizedCompanyDataView
		return ret
	}
	return o.Content
}
...
// SetContent gets a reference to the given []HistorizedCompanyDataView and assigns it to the Content field.
func (o *PageHistorizedCompanyDataView) SetContent(v []HistorizedCompanyDataView) {
	o.Content = v
}
...
func (o PageHistorizedCompanyDataView) MarshalJSON() ([]byte, error) {
...
func (o PageHistorizedCompanyDataView) ToMap() (map[string]interface{}, error) {
...
type NullablePageHistorizedCompanyDataView struct {
	value *PageHistorizedCompanyDataView
	isSet bool
}

func (v NullablePageHistorizedCompanyDataView) Get() *PageHistorizedCompanyDataView {
	return v.value
}

func (v *NullablePageHistorizedCompanyDataView) Set(val *PageHistorizedCompanyDataView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageHistorizedCompanyDataView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageHistorizedCompanyDataView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageHistorizedCompanyDataView(val *PageHistorizedCompanyDataView) *NullablePageHistorizedCompanyDataView {
	return &NullablePageHistorizedCompanyDataView{value: val, isSet: true}
}

func (v NullablePageHistorizedCompanyDataView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageHistorizedCompanyDataView) UnmarshalJSON(src []byte) error {
	v.isSet = true
