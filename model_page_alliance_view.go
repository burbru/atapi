...
// checks if the PageAllianceView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PageAllianceView{}

// PageAllianceView struct for PageAllianceView
type PageAllianceView struct {
	Content []AllianceView `json:"content,omitempty"`
...
// SetContent gets a reference to the given []AllianceView and assigns it to the Content field.
...
func (o PageAllianceView) MarshalJSON() ([]byte, error) {
...
func (o PageAllianceView) ToMap() (map[string]interface{}, error) {
...
type NullablePageAllianceView struct {
	value *PageAllianceView
	isSet bool
}

func (v NullablePageAllianceView) Get() *PageAllianceView {
	return v.value
}

func (v *NullablePageAllianceView) Set(val *PageAllianceView) {
	v.value = val
	v.isSet = true
}

func (v NullablePageAllianceView) IsSet() bool {
	return v.isSet
}

func (v *NullablePageAllianceView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePageAllianceView(val *PageAllianceView) *NullablePageAllianceView {
	return &NullablePageAllianceView{value: val, isSet: true}
}

func (v NullablePageAllianceView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePageAllianceView) UnmarshalJSON(src []byte) error {
	v.isSet = true
